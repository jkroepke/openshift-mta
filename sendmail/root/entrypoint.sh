...
export SENDMAIL_DEFINE_confSERVER_SSL_OPTIONS=${SENDMAIL_DEFINE_confSERVER_SSL_OPTIONS:-"+SSL_OP_NO_SSLv2 +SSL_OP_NO_SSLv3 +SSL_OP_CIPHER_SERVER_PREFERENCE"}
export SENDMAIL_DEFINE_confCLIENT_SSL_OPTIONS=${SENDMAIL_DEFINE_confCLIENT_SSL_OPTIONS:-"+SSL_OP_NO_SSLv2 +SSL_OP_NO_SSLv3"}
export SENDMAIL_DEFINE_confCIPHER_LIST=${SENDMAIL_DEFINE_confCIPHER_LIST:-"HIGH:MEDIUM:!aNULL:!eNULL@STRENGTH"}
